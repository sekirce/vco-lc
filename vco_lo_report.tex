...
\title{VCO as part of PLL} % Title of the assignment
...
\\
Complaints and suggestions: % add to 
...
\begin{itemize}
	...
	% \item Project collaboration ideas:
	% \item Proposed time: 8:00 or 9:00am IST / 7:00 or 8:00am CET, Thursdays
...
Bias % voltage and current bias, resistive bias
\\
...
Reset path delay is needed because of dead zone and that is why blind zone much worse than expected. % so this is a tradeoff
...
\\
-135 dBc at  1 MHz % normalized to 7 GHz
\\
8 GHz
\\
IHP 130 nm SiGe
...
%----------------------------------------------------------------------------------------
\section{PTAT and CTAT, the temperature independant Vbias for cascode}
